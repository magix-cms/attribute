                ...
                <div class="panel-body panel-body-form">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="value">
                            {include file="section/form/list-form.tpl" controller="attribute" sub="value" controller_extend=false dir_controller="" data=$attrvalue id=$page.id_book class_form="col-ph-12 col-lg-4" class_table="col-ph-12 col-lg-8"}
                        </div>
